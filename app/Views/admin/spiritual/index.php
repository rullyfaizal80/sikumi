...
<head>
    ...
    <title>SiKuMi - Pilih Kelas Spiritual</title>
...
<body class="p-4 bg-light">
    <div class="container-fluid" style="max-width: 1000px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="mb-0" style="color: #28a745; font-weight: 700;">🕌 ASPEK SPIRITUAL (Pilih Rombel / Kelas)</h3>
                <p class="text-muted small mb-0">Silakan pilih kelas untuk menginput atau melihat rekap aspek spiritual siswa.</p>
            </div>
            <div>
                               ...
                               <td class="text-center">
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <a href="<?= base_url('admin/spiritual/input/' . esc($r['id'])) ?>" class="btn btn-sm btn-warning text-white font-weight-bold" style="margin-right: 5px;">
                                            📝 Input
                                        </a>
                                        
                                        <!-- Tombol Menuju Rekap -->
                                        <a href="<?= base_url('admin/spiritual/rekap-kelas/' . esc($r['id'])) ?>" class="btn btn-sm btn-info text-white font-weight-bold">
                                            📊 Rekap
                                        </a>
                                    </div>
                                </td>
