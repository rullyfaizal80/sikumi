...
<head>
    ...
    <style>
        ...
        .header-ganjil { background-color: #d4edda; color: #333; }
        .header-genap { background-color: #c3e6cb; color: #333; }
    </style>
</head>
    ...
    <div class="container-fluid" style="max-width: 100%; overflow-x: hidden;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0 mt-1">Akumulasi catatan harian spiritual dijumlahkan per bulan.</p>
            </div>
            <div>
                <a href="<?= base_url('admin/spiritual') ?>" class="btn btn-secondary btn-sm font-weight-bold">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body bg-white py-3">
                <form action="<?= base_url('admin/spiritual/rekap-kelas/'.$rombel_id) ?>" method="GET" class="row align-items-end">
        ...
        <div class="alert alert-secondary shadow-sm mb-3" role="alert">
            ...
            <div class="row small">
                ...
                <div class="col-md-3">
                    <ul class="mb-0 pl-3">
                        <li><strong>3</strong> = Menjalakan Ibadah Shalat</li>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <?php 
                                    ...
                                    $v1 = $rekapData[$sId][$b]['berdoa'] ?? 0;
                                    $v2 = $rekapData[$sId][$b]['kalimat_thoyibah'] ?? 0;
                                    $v3 = $rekapData[$sId][$b]['shalat'] ?? 0;
                                    $v4 = $rekapData[$sId][$b]['salam'] ?? 0;
                                    $v5 = $rekapData[$sId][$b]['syukur'] ?? 0;
                                    $v6 = $rekapData[$sId][$b]['lingkungan'] ?? 0;
                                    $v7 = $rekapData[$sId][$b]['toleransi'] ?? 0;
