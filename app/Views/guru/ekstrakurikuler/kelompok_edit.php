...
<body class="p-4 bg-light">
    ...
    <div class="container-fluid" style="max-width: 1000px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Edit detail kelompok ekstrakurikuler dan kelola anggotanya tanpa takut kehilangan data centangan.</p>
            </div>
            <a href="<?= base_url('guru/ekstrakurikuler/kelompok/show/'.$kelompok['id']) ?>" class="btn btn-outline-secondary btn-sm font-weight-bold">
        ...
        <div class="card shadow-sm border-0">
            <form action="<?= base_url('guru/ekstrakurikuler/kelompok/update/'.$kelompok['id']) ?>" method="POST">
                <?= csrf_field() ?>
                <div class="card-body p-4 bg-white">
                    
                    <h5 class="font-weight-bold text-dark mb-4 border-bottom pb-2"><i class="fas fa-users-cog mr-1 text-warning"></i> Langkah 2: Sesuaikan Detail & Anggota</h5>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <label class="font-weight-bold text-secondary mb-2">Guru Pembina</label>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <select name="jenis_kelompok" id="jenis_kelompok" class="form-control text-dark font-weight-bold" required>
                                <option value="Reguler" <?= (old('jenis_kelompok', $kelompok['jenis_kelompok']) == 'Reguler') ? 'selected' : '' ?>>Reguler (Maks 1 Eskul / Siswa)</option>
                                <option value="Khusus" <?= (old('jenis_kelompok', $kelompok['jenis_kelompok']) == 'Khusus') ? 'selected' : '' ?>>Khusus (Boleh Dobel / Remedial)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            ...
                            <?php if(empty($students)): ?>
                                <div class="text-center text-muted py-3 border bg-light">Belum ada data siswa.</div>
                            <?php else: ?>
                                    ...
                                    <table class="table table-sm table-hover mb-0 bg-white">
                                        <thead class="sticky-header text-dark">
                                            <tr>
                                                ...
                                                <th width="40%">Status Keanggotaan</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                <div class="card-footer bg-light py-3 d-flex justify-content-end">
                    <a href="<?= base_url('guru/ekstrakurikuler/kelompok/show/'.$kelompok['id']) ?>" class="btn btn-secondary font-weight-bold px-3 mr-2">Batal</a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            checkboxes.forEach(cb => cb.addEventListener('change', countSelected));
