...
class PramukaController extends BaseController
{
    // =========================================================================
    // HALAMAN INPUT NILAI PRAMUKA PER KELAS
    // =========================================================================
    public function input($rombel_id)
    {
        ...
        $gradesRaw = $db->table('pramuka_grades')
        ...
        return view('guru/pramuka/input', $data);
    }

    // =========================================================================
    // PROSES SIMPAN NILAI PRAMUKA (SINKRONISASI BATCH)
    // =========================================================================
    public function saveNilai($rombel_id)
    {
        ...
        if (!empty($dataToInsert)) {
            $db->table('pramuka_grades')->insertBatch($dataToInsert);
        }
        ...
        return redirect()->back()->with('success', 'Nilai Pramuka berhasil disimpan!');
    }
}