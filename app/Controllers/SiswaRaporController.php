...
class SiswaRaporController extends BaseController
{
    public function index()
    {
        ...
        // 1. Cek autentikasi Shield dan ambil ID siswa yang sedang login
        if (!auth()->loggedIn()) {
        ...
        // 2. Ambil parameter semester & tahun (opsional via GET)
        ...
        if (empty($dataSiswa)) {
            return redirect()->to('/dashboard')->with('error', 'Data profil siswa tidak ditemukan.');
        }
        ...
        // =========================================================
        // GABUNGKAN DATA UNTUK VIEW SISWA
        // =========================================================
        $data = [
            'dataSiswa'             => $dataSiswa,
        ...
        return view('siswa/rapor_saya_index', $data);
    }
}